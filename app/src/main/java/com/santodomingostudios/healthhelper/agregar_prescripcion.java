...
public class agregar_prescripcion extends Activity {
    int Adia = 0, Ames = 0, Aano = 0, Amin = 0, Ahora = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.agregar_prescripcion);

        nEvento = findViewById(R.id.etEvento);
        ...
        msg2.setTypeface(face);
        bAgregar.setTypeface(face2);
        tvHora.setTypeface(face);
        tvMinuto.setTypeface(face);
        msgSeleccioneH.setTypeface(face);
        tvSeparador.setTypeface(face);
        nEvento.setTypeface(face);
        ...
        bAgregar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                String name = nEvento.getText().toString();
                if(name=="" || Aano==0 || Ahora==0 ){
                    Toast.makeText(agregar_prescripcion.this, "Complete todos los campos", Toast.LENGTH_SHORT).show();
                } else {
                    int dia = Adia, mes = Ames+1, ano = Aano, min = Amin, hour = Ahora;

                    dbconection.insertarDatos(name, dia, mes, ano, min, hour);
                    Toast.makeText(agregar_prescripcion.this, "Evento agregado correctamente", Toast.LENGTH_SHORT).show();
                    Intent main = new Intent(agregar_prescripcion.this, prescripcion.class).setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                    startActivity(main);
                }
