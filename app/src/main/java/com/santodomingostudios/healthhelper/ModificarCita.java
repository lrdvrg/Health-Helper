...
public class ModificarCita extends Activity implements OnClickListener {
    int Sdia, Smes, Sano, Smin, Shora;
    EditText et, etd, eth;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.modificar_cita);

        Intent i = getIntent();
        String Pid = i.getStringExtra("cipId");
        String PInfo = i.getStringExtra("cipInfo");
        String PnombreD = i.getStringExtra("cipNombreD");
        String PnombreH = i.getStringExtra("cipNombreH");
        String Pdia = i.getStringExtra("cipDia");
        String Pmes = i.getStringExtra("cipMes");
        String Pano = i.getStringExtra("cipAno");
        String Pmin = i.getStringExtra("cipMin");
        String Phora = i.getStringExtra("cipHora");
        dbcon = new SQLControlador(this);
        dbcon.abrirBaseDeDatos();

        et = findViewById(R.id.etInfoC);
        etd = findViewById(R.id.etDoctor);
        eth = findViewById(R.id.etCSalud);
        ...
        et.setText(PInfo);
        eth.setText(PnombreH);
        etd.setText(PnombreD);

        tvMinuto.setText(Pmin);
        tvHora.setText(Phora);
        Smin = Integer.valueOf(Pmin);
        Shora = Integer.valueOf(Phora);
        Sdia = Integer.valueOf(Pdia);
        Smes = Integer.valueOf(Pmes);
        Sano = Integer.valueOf(Pano);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.btnActualizar:
                ...
                String segundo = etd.getText().toString();
                String tercero = eth.getText().toString();

                String pHname = tercero;
                String pInfo = primero;
                String pDname = segundo;
                ...
                dbcon.actualizarDatosC(pID, pInfo, pDname, pHname, pDay, pMonth, pYear, pMin, pHour);
                Toast.makeText(this, "Prescripcion actualizada correctamente", Toast.LENGTH_SHORT).show();
                Intent main = new Intent(ModificarCita.this, citas.class).setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                startActivity(main);                break;

            case R.id.btnEliminar:
                dbcon.deleteDataC(pID);
                Toast.makeText(this, "Prescripcion eliminada correctamente", Toast.LENGTH_SHORT).show();
                Intent mai2 = new Intent(ModificarCita.this, citas.class).setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                startActivity(mai2);
                break;
        }
    }
